...
class DatabaseMahasiswa {
    ...
    public void tambahMahasiswa(String nim, String kelas, String nama) { //Menambahkan mahasiswa kedalam database
    ...
    public void hapusMahasiswa(String nim) { //Menghapus mahasiswa dari database
        if (nim.isEmpty()) {
    ...
    public void tambahNilai(String nim, double nilai) { //Menyimpan nilai mahasiswa berdasarkan NIM
        if (nim.isEmpty()) {
            System.out.println("Error: NIM tidak boleh kosong.");
            return;
        }
    ...
    public void tampilkanSemuaNilaiDanRataRata() { //Menampilkan seluruh nilai mahasiswa beserta rata-ratanya
